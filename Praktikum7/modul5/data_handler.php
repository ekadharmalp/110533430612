		...
		if ($view) {
			...
			<form action="" method="post">
				<table class="table">
					<tr>
						<td>NIM*</td>
						<td> <input type="text" name="nim" size=10 value="<?php echo $nim;?>" class="span4" style="height:30px;"/> </td>
					</tr>
					<tr>
						<td>Nama</td>
						<td> <input type="text" name="nama" size=40 value="<?php echo $nama;?>"  class="span4" style="height:30px;"/> </td>
					</tr>
					<tr>
						<td>Alamat</td>
						<td> <input type="text" name="alamat" size=60 value="<?php echo $alamat;?>"  class="span4" style="height:30px;"/> </td>
					</tr>
					<tr>
						<td> </td>
						<td>
